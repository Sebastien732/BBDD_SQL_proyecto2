...
## 8. Encuentra el título de todas las películas que son ‘PG-13 ʼ o tienen una duración mayor a 3 horas en la tabla film
...
## 12. Encuentra el título de las películas en la tabla “filmˮ que NO sean ni ‘NC-
 17 ʼ ni ‘Gʼ en cuanto a su clasificación
...
SELECT CAST(rental_date AS DATE) AS fecha_alquiler,
    COUNT(rental_id) AS cantidad_alquiler_dia
FROM rental
